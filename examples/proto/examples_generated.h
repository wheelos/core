...
struct ChatterBuilder {
  ...
  void add_seq(uint64_t seq) { fbb_.AddElement<uint64_t>(Chatter::VT_SEQ, seq, 0); }
  void add_content(flatbuffers::Offset<flatbuffers::String> content) {
    fbb_.AddOffset(Chatter::VT_CONTENT, content);
  }
  explicit ChatterBuilder(flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<Chatter> CreateChatter(
    flatbuffers::FlatBufferBuilder& _fbb, uint64_t timestamp = 0,
    uint64_t lidar_timestamp = 0, uint64_t seq = 0,
...
inline flatbuffers::Offset<Chatter> CreateChatterDirect(
  ...
  return apollo::cyber::examples::proto::CreateChatter(
      _fbb, timestamp, lidar_timestamp, seq, content__);
}
...
inline const apollo::cyber::examples::proto::Chatter* GetSizePrefixedChatter(
    const void* buf) {
  return flatbuffers::GetSizePrefixedRoot<apollo::cyber::examples::proto::Chatter>(
      buf);
}
...
inline bool VerifySizePrefixedChatterBuffer(flatbuffers::Verifier& verifier) {
  return verifier.VerifySizePrefixedBuffer<apollo::cyber::examples::proto::Chatter>(
      nullptr);
}
